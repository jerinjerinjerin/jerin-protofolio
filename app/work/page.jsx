...
const projects = [
  {
    ...
    image: "/assets/work/project_1_01.png",
    live: "",
    github: "",
  },
  {
    ...
    category: "fullstack",
    title: "project 2",
    description: "fiance app",
    stack: [{ name: "Next.js" }, { name: "Tailwind.css" }, { name: "neon.db" }],
    image: "/assets/work/project_2_01.png",
    live: "",
    github: "",
  },
  {
        ...
        <div className="flex flex-col xl:flex-row xl:gap-[30px]">
          ...
          >
            <div className="flex flex-col">
              {/* outline none */}
              <div
                className="text-8xl leading-none font-semibold
              ...
              text-white group-hover:text-blue-500 transition-all
              ...
              <div className="flex items-center gap-4">
                ...
                <Link href={project.live}>
                  <TooltipProvider delayDuration={100}>
                    <Tooltip>
                      <TooltipTrigger
                        className="size-70px rounded-full p-2
            ...
            >
              ...
              <WorkSliderBtns
               ...
               xl:bottom-0 z-20 w-full justify-between xl:w-max xl:justify-none"
                btnStyles="bg-blue-700 hover:bg-blue-500 text-black text-[22px]
               size-[44px] flex justify-center items-center transition-all"
              />
            </Swiper>
          </div>
        </div>
